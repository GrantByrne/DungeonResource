...
$(document).ready(function () {
    ko.applyBindings(new spell(), document.getElementById('createNode'));
});
                ...
                classToAdd)
{
    ...
    // Attributes that exists to assemble class levels
    ...
    self.addSpellLevel = function () {
        self.SpellLevels.push({ spellClass: this.ClassToAdd, level: this.LevelToAdd });
    };
